...
/*----------------------------------------------
  QUANTITY SELECTOR
----------------------------------------------*/
class pipelineQuantityInput extends HTMLElement {
  constructor() {
    super();
...
customElements.define('pipeline-quantity-input', pipelineQuantityInput);
...
/*----------------------------------------------
  VARIANT CHANGE
----------------------------------------------*/
class pipelineVariantRadios extends HTMLElement {
  constructor() {
    super();
...
customElements.define('pipeline-variant-radios', pipelineVariantRadios);


/*----------------------------------------------
  PRODUCT FORM
----------------------------------------------*/
if (!customElements.get('pipeline-product-form')) {
  ...
  customElements.define('pipeline-product-form', class ProductForm extends HTMLElement {
    constructor() {
      super();
